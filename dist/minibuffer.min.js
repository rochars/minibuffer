...
8-(this.f-this.a);this.g=Math.pow(2,0<a?a:8)-1};d.prototype.s=function(a,c,b){a[b]=8>this.a?0>c?c+Math.pow(2,this.a):c:c&255;return b+1};var p=0===(new Uint8Array((new Uint32Array([1])).buffer))[0],v=p?1:0,w=p?0:1;p=new Int8Array(8);var n=new Uint32Array(p.buffer),r=new Float32Array(p.buffer),x=new Float64Array(p.buffer),t,u,l={};f.prototype.read=function(a,c,b){b=void 0===b?null:b;b=null===b?this.head:b;var e=c.bits/8;if(b+e>a.length)throw Error("Range error");var m=b;m=void 0===m?0:m;g(c);if(c.offset+
m>a.length)throw Error("Bad buffer length.");c.be&&h(a,c.offset,m,m+c.offset);var d=t(a,m);c.be&&h(a,c.offset,m,m+c.offset);this.head=e+b;return d};f.prototype.write=function(a,c,b,e){e=void 0===e?null:e;e=null===e?this.head:e;if(e+c.bits/8>a.length)throw Error("Range error");var d=e;d=void 0===d?0:d;g(c);e=d;d+=c.offset;if(void 0===b)throw Error("Undefined value.");if(null!==b&&-1==[Number,Boolean].indexOf(b.constructor))throw Error("Expected number, boolean or null; found "+b.constructor);for(;e<
d;)e=u(a,b,e);c.be&&h(a,c.offset,e-c.offset,e);this.head=e};f.prototype.readStr=function(a,c,b){b=void 0===b?null:b;b=null===b?this.head:b;c=b+c;if(c>a.length)throw Error("Range error");for(var e="";b<c;b++){var d=b,f=1;d=void 0===d?0:d;f=void 0===f?null:f;f=null!==f?d+f:a.length;for(var g="";d<f;){var k=a[d++];if(0===k>>7)g+=String.fromCharCode(k);else{var h=0;6===k>>5?h=1:14===k>>4?h=2:30===k>>3&&(h=3);k&=(1<<8-h-1)-1;for(var l=0;l<h;l++)k=k<<6|a[d++]&63;65535>=k?g+=String.fromCharCode(k):(k-=65536,
g+=String.fromCharCode((k>>10&1023)+55296,(k&1023)+56320))}}e+=g}this.head=b;return e};f.prototype.writeStr=function(a,c,b,e){b=void 0===b?c.length:b;e=void 0===e?null:e;e=null===e?this.head:e;var d=e+b;if(d>a.length)throw Error("Range error");var f=e;f=void 0===f?0:f;for(var g=[],k=0;k<c.length;k++){var h=c.codePointAt(k);if(128>h)g.push(h);else{var l=0,n=0;2047>=h?(l=1,n=192):65535>=h?(l=2,n=224):1114111>=h&&(l=3,n=240,k++);for(g.push((h>>6*l)+n);0<l;)g.push(128|h>>6*(l-1)&63),l--}}for(c=0;c<g.length;c++)a[f++]=
g[c];this.head=f;if(this.head<e+b)for(;this.head<d;this.head++)a[this.head]=0};return f}();window.MiniBuffer=I;
