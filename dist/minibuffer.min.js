...
r=new Float32Array(l.buffer),x=new Float64Array(l.buffer),n,p,h={};m.prototype.read=function(a,b,c){c=void 0===c?null:c;c=null===c?this.head:c;var d=b.bits/8,e=c;e=void 0===e?0:e;u(b);b.be&&q(a,b.offset,e,e+b.offset);var g=n(a,e);b.be&&q(a,b.offset,e,e+b.offset);this.head+=d+c;return g};m.prototype.write=function(a,b,c,d){d=void 0===d?null:d;var e=d=null===d?this.head:d;e=void 0===e?0:e;u(b);d=e;e+=b.offset;for(var g=b.be;d<e;){if(void 0===c)throw Error("Undefined value.");d=p(a,c,d)}g&&q(a,b.offset,
d-b.offset,d);this.head=d};m.prototype.readStr=function(a,b,c){c=void 0===c?null:c;this.head=null===c?this.head:c;b=this.head+b;if(b>a.length)throw Error("RangeError: Source is too large");for(c="";this.head<b;this.head++){var d=a,e=this.head,g=1;e=void 0===e?0:e;g=void 0===g?null:g;var f="";for(g=g?e+g:d.length;e<g;)t(d[e]),f+=String.fromCharCode(d[e]),e++;c+=f}return c};m.prototype.writeStr=function(a,b,c,d){c=void 0===c?b.length:c;d=void 0===d?null:d;d=null===d?this.head:d;var e=d+c;if(e>a.length)throw Error("RangeError: Source is too large");
var g=d;g=void 0===g?0:g;for(var f=0;f<b.length;f++){var h=b.charCodeAt(f);t(h);a[g]=h;g++}this.head=g;if(this.head<d+c)for(;this.head<e;this.head++)a[this.head]=0};return m}();window.MiniBuffer=G;
