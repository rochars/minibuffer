...
(k-=65536,g+=String.fromCharCode((k>>10&1023)+55296,(k&1023)+56320))}}e+=g}this.head=b;return e};f.prototype.writeStr=function(a,c,b,e){b=void 0===b?c.length:b;e=void 0===e?null:e;e=null===e?this.head:e;var d=e+b;if(d>a.length)throw Error("Range error");var f=e;f=void 0===f?0:f;for(var g=[],k=0;k<c.length;k++){var h=c.codePointAt(k);if(128>h)g.push(h);else{var l=0,n=0;2047>=h?(l=1,n=192):65535>=h?(l=2,n=224):1114111>=h&&(l=3,n=240,k++);for(g.push((h>>6*l)+n);0<l;)g.push(128|h>>6*(l-1)&63),l--}}for(c=
0;c<g.length;c++)a[f++]=g[c];this.head=f;if(this.head<e+b)for(;this.head<d;this.head++)a[this.head]=0};return f}();window.MiniBuffer=I;
