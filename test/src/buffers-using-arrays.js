...
describe('packArrayTo: LE', function() {
    ...
    index = minibuffer.packArrayTo([65535, 765], uInt16, file, index);
...
describe('packArrayTo: BE', function() {
    ...
    // Pack to the typed array passing an index to write
    index = minibuffer.packArrayTo([65535, 765], uInt16BE, file, index);
...
describe('pack to typed array: LE', function() {
    ...
    // Pack to the typed array passing an index to write
    index = minibuffer.packTo(65535, uInt16, file, index);
    index = minibuffer.packTo(765, uInt16, file, index);
...
describe('pack to typed array: BE', function() {
    ...
    // Pack to the typed array passing an index to write
    index = minibuffer.packTo(65535, uInt16BE, file, index);
    index = minibuffer.packTo(765, uInt16BE, file, index);
...
describe('unpackArray: LE', function() {
    ...
    // Pack to the typed array passing an index to write
    var output = minibuffer.unpackArray(file, uInt16, 0, 2);
...
describe('unpackArray: LE (read from the middle of array)', function() {
    ...
    // Pack to the typed array passing an index to write
    var output = minibuffer.unpackArray(file, uInt16, 2, 4);
...
describe('unpackArray: LE (read 2 values)', function() {
    ...
    // Pack to the typed array passing an index to write
    var output = minibuffer.unpackArray(file, uInt16, 0, 4);
...
describe('unpackArray: BE', function() {
    ...
    // Pack to the typed array passing an index to write
    var output = minibuffer.unpackArray(file, uInt16BE, 0, 2);
...
describe('unpackArray: BE (read from the middle of array)', function() {
    ...
    // Pack to the typed array passing an index to write
    var output = minibuffer.unpackArray(file, uInt16BE, 2, 4);
...
describe('unpackArrayTo: LE', function() {
    ...
    it('should unpack the values to the provided array', function() {
        var output = [0,0];
        minibuffer.unpackArrayTo(file, uInt16, output);
        assert.deepEqual(output, [65535, 0]);
    });
    it('should unpack the values to the provided array starting on the index', function() {
        var index = 0;
        var output = [0];
        minibuffer.unpackArrayTo(file, uInt16, output, 2);
        assert.deepEqual(output, [0]);
    });
    it('should unpack the values to the provided array starting on the index', function() {
        var index = 0;
        var output = [0];
        minibuffer.unpackArrayTo(file, uInt16, output, 1);
...
describe('unpackArrayTo: BE', function() {
    ...
    var file = [2, 253, 0, 0];
    var output = [0,0]
    minibuffer.unpackArrayTo(file, uInt16BE, output);
...
describe('unpackFrom: LE', function() {
    ...
    var value = minibuffer.unpack(file, uInt16, index);
...
describe('unpackFrom: BE', function() {
    ...
    // Unpack to the typed array passing an index to read
    var value = minibuffer.unpack(file, uInt16BE, index);
