...
describe('packString ASCII strings', function() {
    it('pack $ as a byte array', function() {
        var chars = '$';
        assert.deepEqual([36], minibuffer.packString(chars));
    });
    it('pack $$ as a byte array', function() {
        var chars = '$$';
        assert.deepEqual([36, 36], minibuffer.packString(chars));
    });
});
...
describe('packString strings', function() {
    it('should turn a string to a byte array', function() {
        assert.deepEqual(
            minibuffer.packString("abcd"), [97,98,99,100]);
    });
...
describe('unpackString strings', function() {
    it('unpackString string, no index, no len', function() {
        assert.deepEqual(
            minibuffer.unpackString([97,98,99,100]), "abcd");
    });
    it('unpackString string, index, no len', function() {
        assert.deepEqual(
            minibuffer.unpackString([97,98,99,100], 1), "bcd");
    });
    it('unpackString string, index, no len', function() {
        assert.deepEqual(
            minibuffer.unpackString([97,98,99,100], 2), "cd");
    });
    it('unpackString string, index, len', function() {
        assert.deepEqual(
            minibuffer.unpackString([97,98,99,100], 1, 3), "bc");
    });
    it('unpackString string, index, len', function() {
        assert.deepEqual(
            minibuffer.unpackString([97,98,99,100], 2, 4), "cd");
    });
});
